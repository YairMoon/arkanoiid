...
int main(){
    ...
    //Fuente y Texto
    if(!fuente.loadFromFile("Fuente/arkanoid.TTF")){
        cout<<"Error al cargar la fuente."<<endl;
    }
    texto.setFont(fuente);
    //Sonidos
    if(!paredSB.loadFromFile("sonidos/RebotePaleta.mp3") || !paletaSB.loadFromFile("sonidos/RebotePaleta.mp3") || !bloqueSB.loadFromFile("sonidos/ReboteLadrillo.mp3")){
